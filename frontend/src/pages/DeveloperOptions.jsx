      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm ${maintenanceMode ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'}`}>
              <Laptop2Icon className="h-4 w-4 mr-2" />
              <span className={`w-2 h-2 rounded-full mr-2 ${maintenanceMode ? 'bg-red-500' : 'bg-green-500'}`} />
